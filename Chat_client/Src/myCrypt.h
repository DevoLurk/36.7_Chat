...
static std::string default_salt{ "Y6sEgFOSx38RM8bHnSteSOsEjqZKZgDuLBY5AecmPFMT000bBlRBmxMCiYKN" };
void my_add_salt(std::string& pass, std::string& salt = default_salt, const int& min_size = 25); // salt 25 + 5
